...
import 'package:markets_owner/src/pages/tracking_roudsman.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/TrackingRoundsman':
        return MaterialPageRoute(builder: (_) => TrackingRoundsman(title: 'Seguimiento',routeArgument: args as RouteArgument,));
      default:
